    ...
    <div class="w-full max-w-4xl glass-panel">
      ...
      <div class="p-8 space-y-8 overflow-y-auto" style="max-height: calc(95vh - 200px);">
        ...
        <div class="bg-amber-500/10 border border-amber-500/25 p-6 rounded-2xl">
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <p class="text-lg text-amber-100 font-medium break-words leading-relaxed"><?php echo e($message); ?></p>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-gray-800/40 border border-cyan-500/15 p-5 rounded-2xl">
            ...
            <div class="ml-9">
              <p class="text-cyan-300 text-base font-semibold truncate" title="<?php echo e($file); ?>"><?php echo e(basename($file)); ?></p>
              <p class="text-gray-400 text-sm mt-1.5 truncate" title="<?php echo e($file); ?>"><?php echo e($file); ?></p>
            </div>
          </div>
          ...
          <div class="bg-gray-800/40 border border-amber-500/15 p-5 rounded-2xl">
            ...
            <div class="ml-9">
              <p class="text-amber-300 text-3xl font-extrabold"><?php echo e($line); ?></p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="code-container">
            <div class="code-header">
              <span class="text-sm text-gray-200 font-medium"><?php echo e(basename($file)); ?></span>
              <span class="text-sm text-amber-400 font-semibold">Line <?php echo e($line); ?></span>
            </div>
            <div class="max-h-[350px] overflow-y-auto">
              ...
              <div class="text-sm">
                <?php for($i = $start; $i <= $end; $i++): ?>
                  <div class="code-line <?php echo e(($i + 1 == $line) ? 'error-line' : ''); ?>">
                    <span class="line-number"><?php echo e($i + 1); ?></span>
                    <span class="line-content"><?php echo htmlspecialchars($lines[$i] ?? ''); ?></span>
                  </div>
                <?php endfor; ?>
              </div>
            </div>
      ...
      <div class="text-center text-gray-400 text-sm border-t border-gray-700/40 py-5 bg-gray-800/20">
        <div class="flex items-center justify-center gap-2">
          ...
          <span>© <?php echo e(date('Y')); ?> THE FRAMEWORK</span>
          <span class="mx-2">•</span>
...
</html><?php /**PATH /home/user/php-praktikum-sipil/services/debug/warning.blade.php ENDPATH**/ ?>