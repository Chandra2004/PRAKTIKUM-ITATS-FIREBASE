    ...
    <section class="hero-section relative py-16 sm:py-24 md:py-32 flex items-center">
        <div class="slideshow-container">
            <div class="slideshow-image active"
                style="background-image: url('<?php echo e(url("assets/images/internal/background-1.webp")); ?>')">
            </div>
            <div class="slideshow-image"
                style="background-image: url('<?php echo e(url("assets/images/internal/background-2.webp")); ?>')">
            </div>
            <div class="slideshow-image"
                style="background-image: url('<?php echo e(url("assets/images/internal/background-3.webp")); ?>')">
            </div>
        </div>
...
<?php echo $__env->make('homepage.layout.layoutHome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/user/php-praktikum-sipil/resources/Views/homepage/home.blade.php ENDPATH**/ ?>