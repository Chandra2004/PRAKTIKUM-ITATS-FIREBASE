                    ...
                    <form id="formPhoto" action="/dashboard/superadmin/profile/update/photo" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="p-6 flex flex-col items-center gap-4">
                            <label for="avatarInput" class="relative w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center cursor-pointer" id="avatar-container">
                                ...
                                <span>
                                    <img src="<?php echo e(url('file.php?file=user-pictures/' . $profilePicture)); ?>" alt="<?php echo e($fullName); ?>" class="w-32 h-32 rounded-full object-cover">
                                </span>
                                <?php else: ?>
                                <span class="text-[#468B97] text-xl font-bold"><?php echo e($initials); ?></span>
                                <?php endif; ?>
                            </label>
                    ...
                    <div class="p-6">
                        <form data-spa action="/dashboard/superadmin/profile/update/data" method="POST" class="space-y-8 px-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <input value="<?php echo e($fullName); ?>" type="text" id="name" name="name" class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm" placeholder="Nama Anda" />
                            </div>

                            <div class="space-y-2">
                                <label for="phone" class="block text-sm font-medium text-[#468B97]">Nomor Telepon</label>
                                <input value="<?php echo e($phone); ?>" type="text" id="phone" name="phone" class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm" placeholder="Nomor telepon aktif" />
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="fakultas" id="fakultas" class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm">
                                    <?php $__currentLoopData = $fakultases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fakultas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($fakultas['kode']); ?>" <?php echo e($fakultas['kode']==$fakultasData ? 'selected' : ''); ?>><?php echo e($fakultas['kode']); ?> | <?php echo e($fakultas['nama']); ?></option>
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="prodi" id="prodi" class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm">
                                    ...
                                    <option value="<?php echo e($prodi['nama']); ?>" <?php echo e($prodi['nama']==$prodiData ? 'selected' : ''); ?>><?php echo e($prodi['nama']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <input name="nomorKampus" value="<?php echo e($nomorKampus); ?>" id="nomorKampus" class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm" placeholder="NIM / NPM" />
                            </div>

                            <div class="space-y-2">
                                <label for="email" class="block text-sm font-medium text-[#468B97]">Email</label>
                                <input name="email" value="<?php echo e($email); ?>" id="email" class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm" placeholder="Alamat email" />
                            </div>

                            <div class="space-y-2">
                                <label for="posisi" class="block text-sm font-medium text-[#468B97]">Posisi</label>
                                <input name="posisi" value="<?php echo e($posisi); ?>" id="posisi" class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm" placeholder="Posisi" />
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="gender" id="gender" class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm">
                                    <option value="Laki-laki" <?php echo e($gender=='Laki-laki' ? 'selected' : ''); ?>>Laki-laki</option>
                                    <option value="Perempuan" <?php echo e($gender=='Perempuan' ? 'selected' : ''); ?>>Perempuan</option>
                                </select>
                            </div>
...
<?php echo $__env->make('dashboard.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/user/php-praktikum-sipil/resources/Views/dashboard/superadmin/profile.blade.php ENDPATH**/ ?>