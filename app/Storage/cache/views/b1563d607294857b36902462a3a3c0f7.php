                            ...
                            <tbody>
                                <?php $__currentLoopData = $receipts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receipt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="bg-white border-b">
                                        <td class="px-6 py-4">
                                            <div class="font-medium text-gray-900"><?php echo e($receipt['Diterima_dari']); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e($receipt['NPM']); ?></div>
                                        </td>
                                        <td class="px-6 py-4 font-mono text-sm"><?php echo e($receipt['No_Kwitansi']); ?></td>
                                        <td class="px-6 py-4 text-right flex justify-end space-x-1">
                                            <button data-modal-target="payment-modal-<?php echo e($receipt['No_Kwitansi']); ?>" data-modal-toggle="payment-modal-<?php echo e($receipt['No_Kwitansi']); ?>" class="p-2 text-gray-500 hover:bg-gray-100 rounded-full" type="button">
                                    ...
                                    <div id="payment-modal-<?php echo e($receipt['No_Kwitansi']); ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            <div class="relative bg-white rounded-lg shadow">
                                                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                                                    <h3 class="text-lg font-semibold text-[#468B97] font-space-grotesk">Bukti Pembayaran: <?php echo e($receipt['Diterima_dari']); ?></h3>
                                                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="payment-modal-<?php echo e($receipt['No_Kwitansi']); ?>">
                                                        <i data-lucide="x" class="w-4 h-4"></i>
                                                ...
                                                <div class="p-4 md:p-5">
                                                    ...
                                                    <div class="mt-4 rounded-md border p-4 bg-gray-50">
                                                        ...
                                                        <div class="grid grid-cols-[max-content_1fr] gap-x-4 gap-y-1 text-sm">
                                                            ...
                                                            <span class="font-mono"><?php echo e($receipt['No_Kwitansi']); ?></span>
                                                            <span class="text-gray-500">Diterima dari:</span>
                                                            <span><?php echo e($receipt['Diterima_dari']); ?></span>
                                                            <span class="text-gray-500">NPM:</span>
                                                            <span class="font-mono"><?php echo e($receipt['NPM']); ?></span>
                                                            <span class="text-gray-500">Untuk Pembayaran:</span>
                                                            <span><?php echo e($receipt['Untuk_Pembayaran']); ?></span>
                                                            <span class="text-gray-500">Jumlah:</span>
                                                            <span class="font-mono"><?php echo e($receipt['Jumlah']); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('dashboard.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/user/php-praktikum-sipil/resources/Views/dashboard/superadmin/payment.blade.php ENDPATH**/ ?>