...
<main class="p-4 sm:p-6">
                        ...
                        <turbo-frame id="users-table">
                                ...
                                <table class="w-full text-sm text-left text-gray-500">
                                    ...
                                    <tbody id="userTableBody">
                                        ...
                                        <tr class="bg-white border-b" data-role="<?php echo e($user['role_name']); ?>" data-name="<?php echo e(strtolower($user['full_name'])); ?>" data-email="<?php echo e(strtolower($user['email'])); ?>" data-npm="<?php echo e($user['npm_nip']); ?>">
                                            ...
                                            <td class="px-6 py-4 text-center flex justify-center space-x-1">
                                                <button data-modal-target="editModal-<?php echo e($user['phone']); ?>" data-modal-toggle="editModal-<?php echo e($user['phone']); ?>" class="p-2 text-gray-500 hover:bg-gray-100 rounded-full" type="button">
                                                    <i data-lucide="edit" class="w-4 h-4"></i>
                                                    <span class="sr-only">Edit</span>
                                                </button>
                                                <button data-modal-target="resetPasswordModal-<?php echo e($user['phone']); ?>" data-modal-toggle="resetPasswordModal-<?php echo e($user['phone']); ?>" class="p-2 text-blue-500 hover:bg-blue-50 hover:text-blue-600 rounded-full" type="button">
                                                    <i data-lucide="key" class="w-4 h-4"></i>
                                                    <span class="sr-only">Reset Password</span>
                                                </button>
                                                <button data-modal-target="deleteModal-<?php echo e($user['uid']); ?>" data-modal-toggle="deleteModal-<?php echo e($user['uid']); ?>" class="p-2 text-red-500 hover:bg-red-50 hover:text-red-600 rounded-full" type="button">
                            ...
                            <div id="paginationWrapper" class="px-4 py-5 sm:p-6 flex justify-between items-center">
                                <div id="pageInfo" class="text-sm text-gray-600">
                                    Halaman <span id="currentPage"><?php echo e($currentPage); ?></span> dari <span id="totalPages"><?php echo e($totalPages); ?></span>
                                </div>
                                <div class="flex space-x-2 items-center">
                                    ...
                                    <form method="POST" data-turbo-frame="users-table" action="/dashboard/superadmin/user-management">
                                        ...
                                        <button <?php echo e($currentPage <= 1 ? 'disabled' : ''); ?> id="submitPrevUser" class="flex gap-2 items-center justify-center px-3 h-8 text-sm font-medium text-gray-500 bg-gray-100 rounded-md hover:bg-gray-300">
                                    ...
                                    <form method="POST" data-turbo-frame="users-table" action="/dashboard/superadmin/user-management">
                                        ...
                                        <button <?php echo e($currentPage >= $totalPages ? 'disabled' : ''); ?> id="submitNextUser" class="flex gap-2 items-center justify-center px-3 h-8 text-sm font-medium text-gray-500 bg-gray-100 rounded-md hover:bg-gray-300">
    ...
    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <!-- Edit User Modal -->
        <div id="editModal-<?php echo e($user['phone']); ?>" data-modal-backdrop="static" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                        <h3 class="text-lg font-semibold text-[#468B97] font-space-grotesk">Edit Pengguna</h3>
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="editModal-<?php echo e($user['phone']); ?>">
                            <i data-lucide="x" class="w-4 h-4"></i>
                            <span class="sr-only">Tutup modal</span>
                        </button>
                    </div>
                    <div class="p-4 md:p-5">
                        <form id="editUserForm-<?php echo e($user['phone']); ?>" action="/dashboard/superadmin/user/update" method="POST" class="mt-4">
                            <?php echo '<input type="hidden" name="_token" value="' . $_SESSION['csrf_token'] . '">'; ?>
                            <div class="grid gap-4">
                                <div class="grid grid-cols-4 items-center gap-4">
                                    <label for="edit-name-<?php echo e($user['phone']); ?>" class="text-right">Nama</label>
                                    <input id="edit-name-<?php echo e($user['phone']); ?>" name="name" type="text" value="<?php echo e($user['full_name']); ?>" class="col-span-3 p-2 border border-gray-300 rounded-lg focus:ring-[#468B97] focus:border-[#468B97]" required />
                                </div>
                                <div class="grid grid-cols-4 items-center gap-4">
                                    <label for="edit-email-<?php echo e($user['phone']); ?>" class="text-right">Email</label>
                                    <input id="edit-email-<?php echo e($user['phone']); ?>" name="email" type="email" value="<?php echo e($user['email']); ?>" class="col-span-3 p-2 border border-gray-300 rounded-lg focus:ring-[#468B97] focus:border-[#468B97]" required />
                                </div>
                                <div class="grid grid-cols-4 items-center gap-4">
                            ...
                            <div class="mt-4 flex justify-end gap-2">
                                <button type="button" data-modal-hide="editModal-<?php echo e($user['phone']); ?>" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-200">Batal</button>
        ...
        <div id="resetPasswordModal-<?php echo e($user['phone']); ?>" data-modal-backdrop="static" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                        <h3 class="text-lg font-semibold text-[#468B97] font-space-grotesk">Reset Password</h3>
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="resetPasswordModal-<?php echo e($user['phone']); ?>">
                            <i data-lucide="x" class="w-4 h-4"></i>
                            <span class="sr-only">Tutup modal</span>
                        </button>
                    </div>
                    <div class="p-4 md:p-5">
                        ...
                        <form id="resetPasswordForm-<?php echo e($user['phone']); ?>" action="/dashboard/superadmin/user/reset-password" method="POST" class="mt-4">
                            <?php echo '<input type="hidden" name="_token" value="' . $_SESSION['csrf_token'] . '">'; ?>
                            <div class="grid gap-4">
                                <div class="grid grid-cols-4 items-center gap-4">
                                    <label for="new-password-<?php echo e($user['phone']); ?>" class="text-right">Password Baru</label>
                                    <input id="new-password-<?php echo e($user['phone']); ?>" name="new_password" type="password" class="col-span-3 p-2 border border-gray-300 rounded-lg focus:ring-[#468B97] focus:border-[#468B97]" required />
                                </div>
                                <div class="grid grid-cols-4 items-center gap-4">
                                    <label for="confirm-password-<?php echo e($user['phone']); ?>" class="text-right">Konfirmasi</label>
                                    <input id="confirm-password-<?php echo e($user['phone']); ?>" name="confirm_password" type="password" class="col-span-3 p-2 border border-gray-300 rounded-lg focus:ring-[#468B97] focus:border-[#468B97]" required />
                                </div>
                                <input type="hidden" name="phone" value="<?php echo e($user['phone']); ?>" />
                            </div>
                            <div class="mt-4 flex justify-end gap-2">
                                <button type="button" data-modal-hide="resetPasswordModal-<?php echo e($user['phone']); ?>" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-200">Batal</button>
        ...
        <!-- Delete User Modal -->
        <div id="deleteModal-<?php echo e($user['uid']); ?>" data-modal-backdrop="static" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                    ...
                    <div class="p-4 md:p-5">
                        ...
                        <form id="deleteUserForm-<?php echo e($user['phone']); ?>" action="/dashboard/superadmin/user-management/delete/<?php echo e($user['id']); ?>/user/<?php echo e($user['uid']); ?>" method="POST" class="mt-4">
                            <?php echo '<input type="hidden" name="_token" value="' . $_SESSION['csrf_token'] . '">'; ?>
                            <div class="mt-4 flex justify-end gap-2">
