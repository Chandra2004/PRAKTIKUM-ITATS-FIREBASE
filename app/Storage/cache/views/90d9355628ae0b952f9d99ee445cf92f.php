                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-gray-900 rounded-lg overflow-hidden">
                            <div class="bg-gray-800 px-4 py-2 text-xs text-gray-400 flex justify-between items-center">
                                ...
                                <span>Line <?php echo e($line); ?></span>
                            </div>
                            <pre class="text-gray-300 font-mono text-sm p-4 overflow-x-auto"><?php $__currentLoopData = explode("\n", file_get_contents($file)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $codeLine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="code-line <?php echo e($i + 1 == $line ? 'highlight-line text-amber-300' : ''); ?>" data-line="<?php echo e($i + 1); ?>"><?php echo htmlspecialchars($codeLine); ?></div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></pre>
                ...
                <div class="glass-panel rounded-xl mb-12 text-left">
                    <div class="p-6">
                        ...
                        <pre class="stack-trace text-gray-300 font-mono text-sm p-4"><?php echo e($trace); ?></pre>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 text-center md:text-left">
                <p class="text-sm text-gray-500">
                    &copy; <?php echo e(date('Y')); ?> The Framework. All rights reserved.
                </p>
...
<?php /**PATH /home/user/php-praktikum-sipil/services/debug/exception.blade.php ENDPATH**/ ?>